package com.jw.james.pattern.proxy.record;

import com.jw.james.pattern.proxy.BaseMethodAspect;
import com.jw.james.pattern.proxy.MethodAdviceHandler;
...
public class InvokeRecordAspect extends BaseMethodAspect {
     ...
     */
    @Override
    @Pointcut("@annotation(com.jw.james.pattern.proxy.record.InvokeRecordAnno)")
