 ...
 * com.ly.travel.mall.trade.postsalecore.facade.model.response.OrderReturnGoodsVO
 * <p>
 ...
 */
@Data
public class OrderReturnGoodsVO implements Serializable {
    /**
     * 下单方式：1:开放平台,2:其它
     */
     ...
     * 退货商品明细
     */
    private List<OrderReturnGoodsItemVO> goodsList;
    /**
     * 是否删除默认为0（1：删除，0：未删除）
     */
